...
\begin{algorithm}
    ...
    \begin{algorithmic}[1]
        ...
        \State \textbf{Step 1:} Get query terms $q_{terms}$ and their embedding (WHAT EMBEDDING)
...
The semantically similar terms are selected from the embedding space to ensure a search within the entire vocabulary and therefore enhance diversity. \footnote{SOURCE} 
